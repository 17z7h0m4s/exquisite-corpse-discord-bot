...
A Discord bot for the Surrealist poetry game.
...
>
> — [Academy of American Poets](https://poets.org/text/play-exquisite-corpse)
...
- `/corpse start` — Start a new poem (bot DMs you)
- `/corpse join` — Join an open poem
- `/corpse status` — Check your game
- `/corpse abandon` — Leave a game

## Setup

1. Clone this repo
2. `pip install discord.py python-do
